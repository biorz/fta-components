import './index.css';
import { View, Text as Text$1, Image, ScrollView } from '@tarojs/components';
...
function Layout(props) {
    const { scrollable, rootClassName, rootStyle, wrapperClassName, wrapperStyle, children, customWrapper } = props, navBarprops = __rest(props, ["scrollable", "rootClassName", "rootStyle", "wrapperClassName", "wrapperStyle", "children", "customWrapper"]);
    ...
    return (React.createElement(View, { className: rootCls, style: rootStyle },
        React.createElement(NavBar, Object.assign({}, navBarprops)),
        React.createElement(Wrapper, { className: wrapperCls, style: wrapperStyle, scrollY: true }, children),
