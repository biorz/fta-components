...
var indexScssStyleSheet = StyleSheet.create({
  ...
  'fta-action-sheet__container': {
    borderTopLeftRadius: scalePx2dp(8.16),
    borderTopRightRadius: scalePx2dp(8.16),
...
var bodyItemScssStyleSheet = StyleSheet.create({
  'fta-action-sheet__item': {
    paddingTop: scalePx2dp(13.92),
    paddingRight: 0,
    paddingBottom: scalePx2dp(13.92),
    paddingLeft: 0,
  ...
  'fta-action-sheet__item__text': {
    ...
    lineHeight: scalePx2dp(18.24),
    color: '#333',
  },
  'fta-action-sheet__item__hint': {
    color: '#999',
    fontSize: scalePx2dp(13.92),
    lineHeight: scalePx2dp(13.92),
    marginTop: scalePx2dp(6.24),
  },
  'item-no-border': {
    borderBottomWidth: 0,
  },
...
var footerScssStyleSheet = StyleSheet.create({
  'fta-action-sheet__footer': {
    ...
    paddingBottom: scalePx2dp(13.92),
    paddingLeft: 0,
    borderTopWidth: scalePx2dp(6.24),
...
var headerScssStyleSheet = StyleSheet.create({
  ...
  'fta-action-sheet__header--complex': {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    minHeight: scalePx2dp(58.56),
  },
  'fta-action-sheet__header-confirm': {
    position: 'absolute',
    overflow: 'hidden',
    right: scalePx2dp(13.92),
    ...
    paddingBottom: scalePx2dp(8.16),
    paddingLeft: scalePx2dp(12),
    borderRadius: scalePx2dp(15.84),
  },
  'fta-action-sheet__header-cancel': {
    position: 'absolute',
    color: '#666',
    fontSize: scalePx2dp(15.84),
    left: scalePx2dp(13.92),
  },
