...
var indexScssStyleSheet = StyleSheet.create({
  ...
  'fta-action-sheet__container': {
    borderTopLeftRadius: scalePx2dp(8.33333),
    borderTopRightRadius: scalePx2dp(8.33333),
...
var bodyItemScssStyleSheet = StyleSheet.create({
  'fta-action-sheet__item': {
    paddingTop: scalePx2dp(14.58333),
    paddingRight: 0,
    paddingBottom: scalePx2dp(14.58333),
    paddingLeft: 0,
  ...
  'fta-action-sheet__item__hint': {
    ...
    lineHeight: scalePx2dp(14.58333),
    marginTop: scalePx2dp(6.25),
  },
  'item-no-border': {
    borderBottomWidth: 0,
  },
...
var footerScssStyleSheet = StyleSheet.create({
  'fta-action-sheet__footer': {
    ...
    paddingBottom: scalePx2dp(14.58333),
    paddingLeft: 0,
    borderTopWidth: scalePx2dp(6.25),
...
var headerScssStyleSheet = StyleSheet.create({
  ...
  'fta-action-sheet__header--complex': {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    minHeight: scalePx2dp(60.9375),
  },
  'fta-action-sheet__header-confirm': {
    position: 'absolute',
    overflow: 'hidden',
    right: scalePx2dp(14.58333),
    ...
    borderRadius: scalePx2dp(16.66667),
  },
  'fta-action-sheet__header-cancel': {
    position: 'absolute',
    color: '#666',
    fontSize: scalePx2dp(16.66667),
    left: scalePx2dp(14.58333),
  },
...
var exampleScssStyleSheet = StyleSheet.create({
  'fta-action-sheet-example': {
    ...
    alignItems: 'center',
    bottom: '100%',
    marginBottom: scalePx2dp(20.83333),
  },
})
