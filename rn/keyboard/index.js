...
var indexScssStyleSheet = StyleSheet.create({
  'fta-keyboard': {
    ...
    paddingTop: 0,
    paddingRight: scalePx2dp(8.16),
    paddingBottom: scalePx2dp(8.16),
    paddingLeft: scalePx2dp(8.16),
    display: 'flex',
    flexDirection: 'row',
  ...
  'fta-keyboard-item': {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    marginTop: scalePx2dp(8.16),
    width: scalePx2dp(109.92),
    height: scalePx2dp(42.24),
    backgroundColor: '#fff',
  ...
  'fta-keyboard-delete': {
    width: scalePx2dp(30.72),
    height: scalePx2dp(18.24),
    overflow: 'hidden',
  },
  'fta-keyboard-delete-square': {
    position: 'absolute',
    height: '100%',
    width: scalePx2dp(21.6),
    top: 0,
    left: scalePx2dp(9.12),
