...
var TabBar = (function (_Component2) {
  _inherits(TabBar, _Component2)
  ...
  _createClass(TabBar, [
    {
      key: 'render',
      value: function render() {
        return React.createElement(View, { style: _styleSheet['fta-tab-bar'] }, this.props.children)
      },
    },
  ])
  return TabBar
