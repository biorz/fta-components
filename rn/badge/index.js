...
var indexScssStyleSheet = StyleSheet.create({
  ...
  'fta-badge-coupon': {
    width: scalePx2dp(5.76),
    height: scalePx2dp(5.76),
    borderRadius: scalePx2dp(4800),
    position: 'absolute',
    top: scalePx2dp(4.8),
    backgroundColor: '#fff',
  ...
  'fta-badge-sector': {
    position: 'absolute',
    zIndex: 0,
    width: scalePx2dp(76.8),
    height: scalePx2dp(76.8),
    borderRadius: scalePx2dp(4800),
    bottom: 0,
    right: scalePx2dp(-38.4),
  },
  'fta-badge-sector--care': {
    width: scalePx2dp(99.84),
    height: scalePx2dp(99.84),
    borderRadius: scalePx2dp(4800),
    right: scalePx2dp(-49.92),
  },
})
