...
var indexScssStyleSheet = StyleSheet.create({
  'fta-badge': {
    ...
    paddingTop: 0,
    paddingRight: scalePx2dp(5.28),
    paddingBottom: 0,
    paddingLeft: scalePx2dp(5.28),
    minWidth: scalePx2dp(15.84),
  },
  'fta-badge-text': {
    zIndex: 1,
    color: '#fff',
    fontSize: scalePx2dp(12),
    lineHeight: scalePx2dp(15.84),
  },
  'fta-badge-text--care': {
    fontSize: scalePx2dp(15.84),
    lineHeight: scalePx2dp(20.64),
  },
  'fta-badge--error': {
  ...
  'fta-badge--care': {
    ...
    minWidth: scalePx2dp(20.64),
    paddingTop: 0,
    paddingRight: scalePx2dp(6.72),
    paddingBottom: 0,
    paddingLeft: scalePx2dp(6.72),
  },
  'fta-badge--rimless': {
    paddingTop: 0,
    paddingRight: 0,
  ...
  'fta-badge--sector': {
    width: scalePx2dp(39.84),
    height: scalePx2dp(39.84),
    borderRadius: 0,
  ...
  'fta-badge-coupon': {
    width: scalePx2dp(6.24),
    height: scalePx2dp(6.24),
    borderRadius: scalePx2dp(4800),
    position: 'absolute',
    top: scalePx2dp(4.8),
    backgroundColor: '#fff',
  ...
  'coupon-left': {
    left: scalePx2dp(-3.12),
  },
  'coupon-left--care': {
    left: scalePx2dp(-3.84),
  },
  'coupon-right': {
  ...
  'fta-badge--sector--care': {
    width: scalePx2dp(51.84),
    height: scalePx2dp(51.84),
  },
  'fta-badge--sector__text': {
    paddingTop: scalePx2dp(6.24),
  },
  'fta-badge--sector__text--care': {
    paddingTop: scalePx2dp(8.16),
  },
  'fta-badge-sector': {
    position: 'absolute',
    zIndex: 0,
    width: scalePx2dp(79.68),
    height: scalePx2dp(79.68),
    borderRadius: scalePx2dp(4800),
    bottom: 0,
    right: scalePx2dp(-39.84),
  },
  'fta-badge-sector--care': {
    width: scalePx2dp(103.68),
    height: scalePx2dp(103.68),
    borderRadius: scalePx2dp(4800),
    right: scalePx2dp(-51.84),
  },
})
