...
var STATUS = {
  success: { src: Assets$1.tip.success, title: '操作成功' },
  error: { src: Assets$1.tip.error, title: '操作失败' },
  waiting: { src: Assets$1.tip.waiting },
  warning: { src: Assets$1.tip.warning },
  info: { src: Assets$1.tip.info },
}
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          desc
            ...
            : null,
          renderBtn ||
            React.createElement(FTAButton, { onClick: onClick, style: _getStyle(btnClz) }, btnText)
        )
      },
    },
  ])
